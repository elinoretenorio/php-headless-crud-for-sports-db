...
class AmericanFootballFumblesStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballFumblesStatsService $service;

    public function __construct(IAmericanFootballFumblesStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballFumblesStatsModel $model */
