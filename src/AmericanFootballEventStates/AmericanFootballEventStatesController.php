...
class AmericanFootballEventStatesController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballEventStatesService $service;

    public function __construct(IAmericanFootballEventStatesService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballEventStatesModel $model */
