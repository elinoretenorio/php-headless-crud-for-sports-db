...
class AmericanFootballDefensiveStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballDefensiveStatsService $service;

    public function __construct(IAmericanFootballDefensiveStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballDefensiveStatsModel $model */
