...
class AmericanFootballOffensiveStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballOffensiveStatsService $service;

    public function __construct(IAmericanFootballOffensiveStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballOffensiveStatsModel $model */
