...
class BaseballActionSubstitutionsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IBaseballActionSubstitutionsService $service;

    public function __construct(IBaseballActionSubstitutionsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var BaseballActionSubstitutionsModel $model */
