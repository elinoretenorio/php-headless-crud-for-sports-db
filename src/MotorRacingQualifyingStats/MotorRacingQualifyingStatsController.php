...
class MotorRacingQualifyingStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IMotorRacingQualifyingStatsService $service;

    public function __construct(IMotorRacingQualifyingStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var MotorRacingQualifyingStatsModel $model */
