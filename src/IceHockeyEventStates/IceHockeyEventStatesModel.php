...
class IceHockeyEventStatesModel implements JsonSerializable
{
    private int $id;
    private int $eventId;
    ...
    public function __construct(IceHockeyEventStatesDto $dto = null)
    {
        if ($dto === null) {
            return;
        }
    ...
    public function toDto(): IceHockeyEventStatesDto
    {
        $dto = new IceHockeyEventStatesDto();
