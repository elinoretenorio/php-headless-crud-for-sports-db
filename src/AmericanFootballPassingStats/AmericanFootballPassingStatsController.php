...
class AmericanFootballPassingStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballPassingStatsService $service;

    public function __construct(IAmericanFootballPassingStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballPassingStatsModel $model */
