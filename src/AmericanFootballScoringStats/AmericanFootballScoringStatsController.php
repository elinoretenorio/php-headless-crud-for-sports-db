...
class AmericanFootballScoringStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballScoringStatsService $service;

    public function __construct(IAmericanFootballScoringStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballScoringStatsModel $model */
