...
class AmericanFootballRushingStatsController 
{
    const ERROR_INVALID_INPUT = "Invalid input";

    private IAmericanFootballRushingStatsService $service;

    public function __construct(IAmericanFootballRushingStatsService $service)
    {
    ...
    public function insert(RequestInterface $request, array $args): ResponseInterface
    {
        ...
        /** @var AmericanFootballRushingStatsModel $model */
